...
public class InverseRealTransformGradientDescent implements RealTransform
{
	...
	public double inverseTol( final double[] target, final double[] guess, final double tolerance, final int maxIters )
	{
		...
		if( error > tolerance )
		{
			System.out.println( "error greater than tolerace for target " + Arrays.toString( target ) + " err: " + error ); 
		}
//		else
//			System.out.println( "error within tolerace for target " + Arrays.toString( target ) + " err: " + error );
